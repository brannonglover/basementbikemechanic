  ...
  return (
    <PageWrapper>
      ...
      <TermsContent>
        ...
        <p>By providing your mobile number and checking the optional SMS consent checkbox in our booking form, you allow <strong>Basement Bike Mechanic</strong> to send SMS updates regarding your bicycle repair. This includes:</p>
        <ul>
        ...
        <ul>
          ...
          <li>You may check the optional SMS consent checkbox to receive text updates.</li>
        </ul>
        <p>The checkbox states: <em>"By checking this box, you are allowing Basement Bike Mechanic to send you repair-related SMS messages, including booking confirmations, service updates, and pickup notifications. No marketing texts. Message frequency varies. Message &amp; data rates may apply. Reply STOP to opt out and HELP for help."</em></p>
        <p>Checking this box is optional. To opt out at any time, reply <strong>STOP</strong> to any message, text <strong>HELP</strong> for assistance, or contact us at <a href="mailto:support@basementbikemechanic.com">support@basementbikemechanic.com</a>. Carriers are not liable for delayed or undelivered messages.</p>
