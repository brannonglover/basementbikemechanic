const siteConfig = {
  ...
  services: [
    ...
    },
    {
      ...
      list: [
        ...
        { id: 1, task: "Limpieza de la cámara de aire" },
    ...
    {
      id: 8,
      service: "Instalación de transmisión",
      list: [
        { id: 0, task: "Reemplazo de todos los componentes de transmisión" },
        { id: 1, task: "Cambio" },
        { id: 2, task: "Bielas" },
        { id: 3, task: "Cassette" },
        { id: 4, task: "Desviador" },
    ...
    {
      id: 9,
      service: "Instalación de horquilla de suspensión",
      list: [
        { id: 0, task: "Retirar la horquilla vieja" },
        { id: 1, task: "Transferir la copa de dirección" },
        { id: 2, task: "Cortar el tubo de dirección nuevo" },
        { id: 3, task: "Instalar tuerca de arranque si es necesario (salvo SWAT)" },
        { id: 4, task: "Reinstalar espaciadores/potencia" },
        { id: 5, task: "Reinstalar freno delantero" },
      ],
      price: 100,
    },
  ],
  ...
  individual_services: [
    ...
    { id: 3, service: "Reemplazo de cámara y/o neumático (por neumático)", price: 20 },
    ...
    { id: 26, service: "Ajuste de freno de disco mecánico", price: 20 },
    { id: 27, service: "Alineación de V-Brake", price: 15 },
    { id: 10, service: "Alineación de patilla de cambio", price: 35 },
    { id: 28, service: "Instalación de patilla de cambio", price: 20 },
    { id: 11, service: "Reemplazo de cable (por cable)", price: 15 },
    { id: 12, service: "Reemplazo de cable y funda (por cable)", price: 35 },
    { id: 29, service: "Reemplazo de cable y funda ebike (por cable)", price: 65 },
    { id: 30, service: "Cables con paso interno", price: 50 },
    { id: 13, service: "Indexado de cambios", price: 25 },
    { id: 14, service: "Reemplazo de cadena", price: 10 },
    { id: 32, service: "Instalación de componente", price: 55 },
    { id: 33, service: "Instalación de componente e-bike", price: 75 },
    { id: 17, service: "Envoltura de manillar de carretera", price: 35 },
    { id: 34, service: "Re-envoltura de manillar de carretera", price: 15 },
    { id: 35, service: "Reinstalación de acoples aerodinámicos", price: 35 },
    { id: 18, service: "Instalación de pedales", price: 8 },
    { id: 36, service: "Instalación de biela", price: 45 },
    { id: 37, service: "Roscado de biela", price: 35 },
    { id: 38, service: "Reemplazo de pedalier", price: 45 },
    { id: 19, service: "Reemplazo de rodamientos de buje", price: 35 },
    { id: 39, service: "Reconstrucción de buje trasero", price: 75 },
    { id: 40, service: "Instalación de roda libre", price: 25 },
    { id: 41, service: "Reemplazo de radio", price: 5 },
    { id: 42, service: "Ajuste de dirección", price: 15 },
    { id: 43, service: "Ajuste de dirección ebike", price: 35 },
    { id: 44, service: "Instalación de freno hidráulico ebike (delantero)", price: 35 },
    { id: 45, service: "Instalación de freno hidráulico ebike (trasero)", price: 75 },
    { id: 46, service: "Instalación de disco ebike (delantero)", price: 25 },
    { id: 47, service: "Instalación de disco ebike (trasero)", price: 35 },
    { id: 48, service: "Instalación de rueda con cableado ebike", price: 125 },
...
const messages = {
  ...
  bikes: {
    ...
    sold: "Vendida",
    soldBanner: "Esta bicicleta ha sido vendida",
