...
// Public Turnstile site key (same widget as BikeOps). CRA only inlines REACT_APP_*.
// Hardcoded fallback so a misnamed Netlify env (e.g. NEXT_PUBLIC_*) cannot blank the widget.
