...
export const lightTheme = {
  ...
  colors: {
    ...
    primaryDark: "#25649a",
    primarySoft: "#d4e8f5",
    /** Tune-up cards & à la carte price cells — slate, not blue */
    serviceHeader: "#334155",
    serviceHeaderDark: "#1e293b",
    servicePriceBg: "#e2e8f0",
    servicePriceText: "#0f172a",
    accent: "#e8b00c",
    accentHover: "#d4a20a",
    accentMuted: "#fef3c7",
    textOnAccent: "#18181b",
...
export const darkTheme = {
  ...
  colors: {
    ...
    serviceHeader: "#475569",
    serviceHeaderDark: "#334155",
    servicePriceBg: "rgba(148, 163, 184, 0.15)",
    servicePriceText: "#e2e8f0",
    accent: "#e8b00c",
    accentHover: "#f0c030",
